...
#
# Generated by export_simulation on Sun Jan 21 17:22:12 -0800 2024
#
################################################################################
...
'-reset_run' switch to the './inclinometer.sh' script.

./inclinometer.sh -reset_run
...
./inclinometer.sh -noclean_files

For more information on the script, please type './inclinometer.sh -help'.
