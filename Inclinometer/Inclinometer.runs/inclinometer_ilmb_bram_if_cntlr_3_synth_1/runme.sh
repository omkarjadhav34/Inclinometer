...
HD_PWD='C:/Users/jadha/OneDrive/Desktop/TA/ECE544-Winter24/Inclinometer/Inclinometer.runs/inclinometer_ilmb_bram_if_cntlr_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inclinometer_ilmb_bram_if_cntlr_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inclinometer_ilmb_bram_if_cntlr_3.tcl
