...
HD_PWD='C:/Users/jadha/OneDrive/Desktop/TA/ECE544-Winter24/github_repo/Inclinometer/Inclinometer/Inclinometer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inclinometer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inclinometer.tcl -notrace
