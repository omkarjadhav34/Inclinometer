...
HD_PWD='C:/Users/jadha/OneDrive/Desktop/TA/ECE544-Winter24/Inclinometer/Inclinometer.runs/inclinometer_bidirec_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inclinometer_bidirec_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inclinometer_bidirec_0_1.tcl
