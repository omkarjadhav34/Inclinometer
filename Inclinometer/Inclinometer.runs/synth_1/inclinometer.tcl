...
synth_design -top inclinometer -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef inclinometer.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file inclinometer_utilization_synth.rpt -pb inclinometer_utilization_synth.pb"
