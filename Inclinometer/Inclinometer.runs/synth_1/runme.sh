...
HD_PWD='C:/Users/jadha/OneDrive/Desktop/TA/ECE544-Winter24/github_repo/Inclinometer/Inclinometer/Inclinometer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inclinometer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inclinometer.tcl
