...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -g -ffunction-sections -fdata-sections -Wall -Wextra -fno-tree-loop-distribute-patterns -mxl-float-sqrt
END
